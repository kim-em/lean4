...
#define LEAN_INIT_LOG(msg) EM_ASM({ console.log("[INIT:Lean] " + UTF8ToString($0)); }, msg)
#else
#define LEAN_INIT_LOG(msg) ((void)0)
#endif
...
_G_initialized = true;
LEAN_INIT_LOG("Initializing Init...");
res = initialize_Init(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Data...");
res = initialize_Lean_Data(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Compiler...");
res = initialize_Lean_Compiler(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Environment...");
res = initialize_Lean_Environment(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Modifiers...");
res = initialize_Lean_Modifiers(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ProjFns...");
res = initialize_Lean_ProjFns(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Runtime...");
res = initialize_Lean_Runtime(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ResolveName...");
res = initialize_Lean_ResolveName(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Attributes...");
res = initialize_Lean_Attributes(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Parser...");
res = initialize_Lean_Parser(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ReducibilityAttrs...");
res = initialize_Lean_ReducibilityAttrs(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Elab...");
res = initialize_Lean_Elab(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Class...");
res = initialize_Lean_Class(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.LocalContext...");
res = initialize_Lean_LocalContext(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.MetavarContext...");
res = initialize_Lean_MetavarContext(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.AuxRecursor...");
res = initialize_Lean_AuxRecursor(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Meta...");
res = initialize_Lean_Meta(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Util...");
res = initialize_Lean_Util(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Structure...");
res = initialize_Lean_Structure(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.PrettyPrinter...");
res = initialize_Lean_PrettyPrinter(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.CoreM...");
res = initialize_Lean_CoreM(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ReservedNameAction...");
res = initialize_Lean_ReservedNameAction(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.InternalExceptionId...");
res = initialize_Lean_InternalExceptionId(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Server...");
res = initialize_Lean_Server(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ScopedEnvExtension...");
res = initialize_Lean_ScopedEnvExtension(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.DocString...");
res = initialize_Lean_DocString(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.DeclarationRange...");
res = initialize_Lean_DeclarationRange(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.LoadDynlib...");
res = initialize_Lean_LoadDynlib(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Widget...");
res = initialize_Lean_Widget(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Log...");
res = initialize_Lean_Log(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Linter...");
res = initialize_Lean_Linter(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.SubExpr...");
res = initialize_Lean_SubExpr(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.LabelAttribute...");
res = initialize_Lean_LabelAttribute(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.AddDecl...");
res = initialize_Lean_AddDecl(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Replay...");
res = initialize_Lean_Replay(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.PrivateName...");
res = initialize_Lean_PrivateName(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.LibrarySuggestions...");
res = initialize_Lean_LibrarySuggestions(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Namespace...");
res = initialize_Lean_Namespace(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.EnvExtension...");
res = initialize_Lean_EnvExtension(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ErrorExplanation...");
res = initialize_Lean_ErrorExplanation(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ErrorExplanations...");
res = initialize_Lean_ErrorExplanations(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.DefEqAttrib...");
res = initialize_Lean_DefEqAttrib(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.Shell...");
res = initialize_Lean_Shell(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("Initializing Lean.ExtraModUses...");
res = initialize_Lean_ExtraModUses(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_INIT_LOG("All Lean modules initialized successfully!");
