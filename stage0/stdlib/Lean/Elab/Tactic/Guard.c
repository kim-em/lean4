...
static const lean_string_object l_Lean_Elab_Tactic_GuardExpr_MatchKind_toStringDescr___closed__6_value = {.m_header = {.m_rc = 0, .m_cs_sz = 0, .m_other = 0, .m_tag = 249}, .m_size = 69, .m_capacity = 69, .m_length = 68, .m_data = "definitionally equal (unfolding instances and implicit_reducible) to"};
...
lean_closure_set(v___f_1752_, 4, v___y_1739_);
lean_closure_set(v___f_1752_, 5, v___y_1747_);
v___x_1753_ = l_Lean_Elab_Tactic_withMainContext___redArg(v___f_1752_, v___y_1748_, v___y_1742_, v___y_1740_, v___y_1746_, v___y_1744_, v___y_1743_, v___y_1741_, v___y_1745_);
return v___x_1753_;
}
v___jp_1755_:
{
...
lean_closure_set(v___f_1801_, 3, v___y_1793_);
lean_closure_set(v___f_1801_, 4, v___y_1790_);
v___x_1802_ = l_Lean_Elab_Tactic_withMainContext___redArg(v___f_1801_, v___y_1795_, v___y_1797_, v___y_1794_, v___y_1792_, v___y_1791_, v___y_1796_, v___y_1789_, v___y_1798_);
return v___x_1802_;
}
v___jp_1804_:
{
