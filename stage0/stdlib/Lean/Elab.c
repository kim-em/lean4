...
#define LEAN_ELAB_INIT_LOG(msg) EM_ASM({ console.log("[INIT:Elab] " + UTF8ToString($0)); }, msg)
#else
#define LEAN_ELAB_INIT_LOG(msg) ((void)0)
#endif
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("Initializing Elab.InfoTrees...");
res = initialize_Lean_Elab_InfoTrees(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("Initializing Elab.ErrorExplanation...");
res = initialize_Lean_Elab_ErrorExplanation(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("Initializing Elab.DocString...");
res = initialize_Lean_Elab_DocString(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("Initializing Elab.DocString.Builtin...");
res = initialize_Lean_Elab_DocString_Builtin(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("Initializing Elab.Parallel...");
res = initialize_Lean_Elab_Parallel(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
LEAN_ELAB_INIT_LOG("All Elab modules initialized!");
